...
byte colPins [cols] = {18, 19, 12, 11}; 

Keypad myKeypad = Keypad( makeKeymap(keyMap), rowPins, colPins, rows, cols);

LiquidCrystal lcd(5, 4, 3, 2, 1, 0); // pins of the LCD. (RS, E, D4, D5, D6, D7)(A0, A1, A2, A3, A4, A5)
...
//  myservo.write(45); 
  lcd.begin(16, 2);
   pinMode (VUVK, OUTPUT);
    pinMode (VLVK, OUTPUT);
     pinMode (SSSMS, OUTPUT);
      pinMode (vuvgsm, INPUT);
       pinMode (vlvgsm, INPUT);
...
//      }
      ...
      VUVGSM = digitalRead(vuvgsm);
      VLVGSM = digitalRead(vlvgsm);
    ...
    int timeleft=90;
      do
       ...
       int Timeleft=60- ((millis()/1000)-timer);
        ...
        {
          lcd.print ("0");
           lcd.print(59- ((millis()/1000)-timer));
          }
          else
          {
        lcd.print(59- ((millis()/1000)-timer));
