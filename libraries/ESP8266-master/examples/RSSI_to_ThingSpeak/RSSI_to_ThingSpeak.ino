...
// Wi-Fi Settings
const char* ssid = "Home_wifi"; // your wireless network name (SSID)
const char* password = "ADEJOSH4real$"; // your Wi-Fi network password

WiFiClient client;

// ThingSpeak Settings
const int channelID = 407690;
String writeAPIKey = "6JPGP70FSMUK7DAM"; // write API key for your ThingSpeak Channel
