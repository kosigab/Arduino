...
virtuabotixRTC myRTC(5, 4, 6); //If you change the wiring change the pins here also
...
// Set the current date, and time in the following format:
 ...
 myRTC.setDS1302Time(0, 35, 20, 4, 19, 9, 2018); //Here you write your actual time/date as shown above 
