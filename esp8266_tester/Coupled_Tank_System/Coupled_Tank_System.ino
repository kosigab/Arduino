...
#define reSet 15
#define buzzer 5
#define tankA_inlet_pump 3 //ash
#define tankB_inlet_pump 4 //green
#define tankC_inlet_pump 30 //blue
#define tankA_outlet_valve 31 //yellow
#define tankB_outlet_valve 32 //orange
...
void fill_tank_B()
{
  ...
  {
    digitalWrite(tankB_inlet_pump, LOW);
    digitalWrite(tankB_inlet_pump, 0);
  }
...
{
  double volume = 0;
  double fluid_height = 8.9 - ult_dist;
  if (fluid_height < 0)
  {
    fluid_height = 0;
  }
